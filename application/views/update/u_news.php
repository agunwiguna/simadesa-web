            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <form action="<?=base_url('info/ubah')?>" method="post" autocomplete="off" enctype="multipart/form-data">
                        <input type="hidden" name="id_info" value="<?=$row['id_info']?>">                      
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Judul</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="text" value="<?=$row['judul']?>" name="judul" class="form-control" required>
                            </div>
                        </div> 
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Deskripsi</label>
                            <div class="col-sm-12 col-md-7">
                                <textarea id="summernote" name="deskripsi" required><?=$row['deskripsi']?></textarea>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
   ...
   <script type="text/javascript">
        $(document).ready(function(){
            ...
            function uploadImage(image) {
                ...
                $.ajax({
                    url: "<?php echo site_url('berita/upload')?>",
                    cache: false,
                    contentType: false,
                    processData: false,
                    data: data,
            ...
            function deleteImage(src) {
                $.ajax({
                    data: {src : src},
                    type: "POST",
                    url: "<?php echo site_url('berita/deletes')?>",
                    cache: false,
